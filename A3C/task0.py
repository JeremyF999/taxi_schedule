...
class Main(Launcher):
    ...
    def env_agent_config(self,cfg,logger):
        ...
        n_actions = env.action_space  # action dimension
    ...
    def train_one_episode(self, env, agent, cfg):
        ...
        for _ in range(cfg.max_steps):
            ...
            next_state, reward, terminated , info = env.step(action)  # update env and return transitions
